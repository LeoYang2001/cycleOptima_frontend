              ...
              {index <= value && (
                <CheckFilled
                  className={cn(
                    ...
                    value === index &&
                      "text-gray-300 dark:text-lime-500 opacity-100"
                  )}
                />
              )}
            </div>
    ...
    <AnimatePresence mode="wait">
      {loading && (
        <motion.div
          ...
          className="w-full h-full  border inset-0 z-[100] flex items-center justify-center backdrop-blur-2xl"
        >
          <div className="h-96  -translate-y-20  relative">
